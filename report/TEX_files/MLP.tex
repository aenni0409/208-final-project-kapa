For the multilayer perceptron model, we tuned the hidden layer size. The following tables shows the runtime and accuracy results with respect to each layer for both the uni-gram and bi-gram method. The other model parameters are kept at default with the exception of letting the activation function be logistic. \\
