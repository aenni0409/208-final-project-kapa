...
\section{Description of Data} \label{sec:Decript}

\subsection{Raw Data}
Year ( 1999 - 2007 ) \\
Sample ( Total  ) \\
Source (Difficulity of cleaning, how to deal with it( combination of different source, HTML….)\\
%\input{filename}
%Please use \subsection{Data Cleaning} to add subsection

\subsection{Top 50 Words Per Year}
